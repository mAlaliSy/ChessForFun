...
class MovesGenerator() {
    companion object {
        ...
        fun getAvailableMoves(board: Array<Array<Piece?>>, point: Point, lastMove: com.malalisy.chessforfun.pojos.Move?): List<com.malalisy.chessforfun.pojos.Move> {
            return when (board[point.y][point.x]) {
                is Pawn -> availableMovesForPawn(board, point, lastMove)
                is Bishop -> availableMovesForBishop(board, point)
                is Knight -> availableMovesForKnight(board, point)
                is Rook -> availableMovesForRook(board, point)
                is Queen -> availableMovesForQueen(board, point)
                else -> availableMovesForKing(board, point)
            }
        }

        fun availableMovesForKing(board: Array<Array<Piece?>>, point: Point): List<com.malalisy.chessforfun.pojos.Move> {
            val list = ArrayList<com.malalisy.chessforfun.pojos.Move>()
        ...
        fun availableMovesForQueen(board: Array<Array<Piece?>>, point: Point): List<com.malalisy.chessforfun.pojos.Move> {
            val list = ArrayList<com.malalisy.chessforfun.pojos.Move>()
        ...
        fun availableMovesForRook(board: Array<Array<Piece?>>, point: Point): List<com.malalisy.chessforfun.pojos.Move> {
            val list = ArrayList<com.malalisy.chessforfun.pojos.Move>()
        ...
        fun availableMovesForBishop(board: Array<Array<Piece?>>, point: Point): List<com.malalisy.chessforfun.pojos.Move> {
            val list = ArrayList<com.malalisy.chessforfun.pojos.Move>()
        ...
        fun availableMovesForKnight(board: Array<Array<Piece?>>, point: Point): List<com.malalisy.chessforfun.pojos.Move> {
            val list = ArrayList<com.malalisy.chessforfun.pojos.Move>()
            val piece = board[point.y][point.x]!!
        ...
        fun availableMovesForPawn(board: Array<Array<Piece?>>, point: Point, lastMove: com.malalisy.chessforfun.pojos.Move?): List<com.malalisy.chessforfun.pojos.Move> {
            val list = ArrayList<com.malalisy.chessforfun.pojos.Move>()
